...
def index(request):
    ...
    return render(request, 'review_books/index.html', context)

def add_book(request):
    context = {
        "authors": Author.objects.all()
    }
    return render(request, 'review_books/add.html', context)

def show(request, book_id):
    context = {
        'book': Book.objects.get(id=book_id)
    }
    return render(request, 'review_books/show.html', context)
